...
// DESIGN SYSTEM
const C = {
  bg:"#060809", surf:"#0F1D28", card:"#162635", cardHi:"#1C3040",
  bord:"#1E3244", bord2:"#263E54",
  acc:"#00E5A0", aLo:"#00E5A015", aLo2:"#00E5A025",
  blu:"#38BDF8", bLo:"#38BDF815",
  ora:"#FBBF24", oLo:"#FBBF2415",
  red:"#F87171", rLo:"#F8717115",
  yel:"#FDE68A", yLo:"#FDE68A15",
  pur:"#A78BFA", pLo:"#A78BFA15",
  txt:"#F0F4F8", mid:"#607A8C", dim:"#131C22",
  g1:"#00E5A0", g2:"#38BDF8",
  // meal accent colors
  mCol:(name)=>{
    const n=(name||"").toLowerCase();
    if(["colazione","breakfast"].some(k=>n.includes(k))) return "#FBBF24";
    if(["pranzo","lunch"].some(k=>n.includes(k))) return "#00E5A0";
    if(["cena","dinner"].some(k=>n.includes(k))) return "#38BDF8";
    return "#A78BFA";
  },
};
const FONTS = `
...
@keyframes glow{0%,100%{box-shadow:0 0 0 0 #00E5A000}50%{box-shadow:0 0 28px 8px #00E5A044}}
@keyframes glowBar{0%,100%{box-shadow:0 0 0 0 #00E5A000}50%{box-shadow:0 0 10px 2px #00E5A066}}
    ...
    <div style={{...ss,display:"flex",flexDirection:"column",justifyContent:"center",minHeight:"100vh",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{padding:"0 28px",position:"relative",zIndex:1}}>
        ...
        <div style={{textAlign:"center",marginBottom:36}}>
          ...
          <div style={{fontSize:28,fontWeight:900,letterSpacing:-1,background:`linear-gradient(90deg,${C.txt},${C.mid})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>NutriCalc</div>
          <div style={{fontSize:13,color:C.mid,marginTop:4,fontWeight:500}}>{_lang==="en"?"Your personal nutritional plan":"Il tuo piano nutrizionale personale"}</div>
        </div>
                  ...
                  return (
                    <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:i<Math.min(3,items.length-1)?8:0,padding:"3px 0"}}>
                      <div style={{display:"flex",alignItems:"center",gap:8,flex:1,minWidth:0}}>
                        ...
                        <span style={{fontSize:12,color:C.mid,flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{item.food.name}</span>
...
function MealDetailScreen({mealName,mealData,items,tot,target,pantry,customFoods,favMeals,lang,onBack,onAdd,onRemove,onQty,onUnit,onGenerate,onGenerateDB,onClear,onSaveFav,onApplyFav,onDeleteFav,onRecalc,onAddItems,isConfirmed,isLocked,onUnconfirm,onUnlock,onSaveCustomFood}) {
